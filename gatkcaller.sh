...
split -d -n l/${CORES} forIndelAligner.intervals tmp_intervals_ || exit 1
parallel java -jar ${GATK} -T IndelRealigner -R ${REFERENCEFILE} -I dedup.bam -targetIntervals tmp_intervals_{} -o tmp_realigned_{}.bam ::: $(seq -f %02.0f 0 $((CORES-1))) || exit 1
