...
python2 ${PATHTOZYPY}/diploidify.py -i cleaned.fasta -t fasta -o cleaned.dip.phylip-relaxed -p phylip-relaxed || exit 1

#This keeps the ambiguous notation to collect some stats used by supported_sites.py
python2 ${PATHTOZYPY}/diploidify.py -i cleaned.fasta -t fasta -o cleaned.het.phylip-relaxed -p phylip-relaxed -s || exit 1
...
python2 ${PATHTOZYPY}/supported_sites.py -t tree/RAxML_bipartitions.nwk -a cleaned.het.phylip-relaxed -s -o supp_table.txt -z zygosity.txt -n || exit 1
...
python2 ${PATHTOZYPY}/diploidify.py -i ../cleaned.fasta -t fasta -o cleaned.het.phylip-relaxed -p phylip-relaxed -v -s || exit 1
